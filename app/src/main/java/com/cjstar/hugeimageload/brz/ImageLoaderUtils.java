...
public class ImageLoaderUtils {
    ...
    public static Bitmap loadHugeBitmapFromDrawable(Resources resources, int drawableId, int imgH, int imgW) {
        ...
        //preload set inJustDecodeBounds true, this will load bitmap into memmery
        ...
        Log.d(TAG, "memmery size:" + getBitmapSizeInMemmery(width / sampleSize, height / sampleSize));
    ...
    public static long getBitmapSizeInMemmery(int imageW, int imageH) {
